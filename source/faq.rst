...
| A: 可以！直接打开就行。 进一步了解 :doc:`MP3</tutorial/mp3>`
| 
| Q：Aboboo能加载MP3的LRC吗？
| A：可以！如果lRC文件和MP3在同一个目录，只是文件扩展名不同，Aboboo会自动加载LRC；否则，请通过 **课件** > **加载字幕** 加载LRC文件。
| 
| Q：Aboboo能手工断句吗？
| A：可以！如果打开的不是课件，而是自己可以更改断点的文件（例如：MP3)，请将鼠标移到主波形，按下Ctrl，状态栏提示操作。进一步了解 :doc:`手工断句</tutorial/shou-gong-duan-ju>` 
| 
| Q：如何循环播放一个文件？
...
| A：选择 **是(Y)** 前往授权界面，按照提示获得授权。 进一步了解 :doc:`课件授权</tutorial/ke-jian>`
| 
| Q：视频不能播放怎么办？
| A： **参数设置** >> **初始化视频设置** 。
|
