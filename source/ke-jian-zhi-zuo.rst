...
* 如果MP3有高质量的LRC字幕，也能用上：
    ...
    1. 在主界面中以学习模式打开MP3。
    2. 在主菜单中选择 **课件** **加载字幕** （参看 :doc:`MP3</tutorial/mp3>` ）。 
...
弹出 **智能断句** 界面，请选择断句方案或微调断句参数，完成断句。请参看 :doc:`智能断句</tutorial/zhi-neng-duan-ju>` 。 
...
波形面板操作与主界面波形面板基本一致，只屏蔽了部分只用于学习的操作。请参阅 :doc:`手工断句</tutorial/shou-gong-duan-ju>`  一章以了解手工断句操作。
